...
public class TaskMaint : Il2CppSystem.Object
{
	...
	static TaskMaint()
	{
		Il2CppClassPointerStore<TaskMaint>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "", "TaskMaint");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr);
		NativeFieldInfoPtr_index = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "index");
		NativeFieldInfoPtr_max = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "max");
		NativeFieldInfoPtr_counts = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "counts");
		NativeFieldInfoPtr_taskId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "taskId");
		NativeFieldInfoPtr_names = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "names");
		NativeFieldInfoPtr_details = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "details");
		NativeFieldInfoPtr_subNames = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "subNames");
		NativeFieldInfoPtr_contentInfo = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "contentInfo");
		NativeFieldInfoPtr_count = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, "count");
		NativeMethodInfoPtr__ctor_Public_Void_Int16_SByte_String_String_Il2CppStringArray_Il2CppStructArray_1_Int16_Int16_Il2CppStringArray_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr, 100666332);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 108524, XrefRangeEnd = 108543, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TaskMaint(short taskId, sbyte index, string name, string detail, Il2CppStringArray subNames, Il2CppStructArray<short> counts, short count, Il2CppStringArray contentInfo)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TaskMaint>.NativeClassPtr))
	{
	...
	public TaskMaint(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
